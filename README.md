...
2. **Line search**: Use a Han-Powell L1 merit function \(\phi(x;\rho) = f(x) + \rho\,(\|c_{\text{eq}}\|_1 + \|\max(0, -c_{\text{ineq}})\|_1)\) with backtracking Armijo conditions to determine the step size.
